    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identity', models.CharField(choices=[('student', 'Student'), ('teacher', 'Teacher')], default='student', help_text='身份', max_length=7)),
                ('phone', models.CharField(blank=True, help_text='手机号码', max_length=11, null=True)),
