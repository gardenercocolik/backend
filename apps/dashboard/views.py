...
from .models import PDFproofOfRecord,ReportCompetition, RecordCompetition, MainCompetition, ProofOfRecord, PhotoOfRecord, CertificateOfRecord, Team, TeamMember
