    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reimbursement_amount', models.DecimalField(decimal_places=2, max_digits=10, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('proof', models.ImageField(upload_to=dashboard.models.upload_proof_path)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('photo', models.ImageField(upload_to=dashboard.models.upload_photo_path)),
                ('record', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dashboard.recordcompetition')),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('certificate', models.FileField(upload_to=dashboard.models.upload_certificate_path)),
                ('record', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dashboard.recordcompetition')),
            ],
            options={
                'abstract': False,
